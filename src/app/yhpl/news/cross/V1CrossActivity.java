...
public class V1CrossActivity extends LogActivity {
	...
	public Fragment getDefaultFragment() {
		...
		// V1ListViewFragment.class.getName());
		//
		// ListViewConfig config = new ListViewConfig();
		// config.putInt(BundleKeys.KEY_I_TITLE, R.string.title_channel);
		// config.putInt(BundleKeys.KEY_I_TITLE_LEFT,
		// R.drawable.v1_icon_titlebar_back);
		// config.putInt(BundleKeys.KEY_I_LAYOUT,
		// R.layout.v1_fragment_listview_titlebar);
		// config.putInt(BundleKeys.KEY_I_HTTP_PARSER_TYPE,
		// ParserTag.HTTP_PARSER_CHANNEL);
		// config.putInt(BundleKeys.KEY_I_ADAPTER,
		// AdapterEnum.CHANNESL.getFlag());
